...
export default function AboutPage() {
  return (
    <div className="min-h-app bg-background">
      <div className="mx-auto w-full max-w-xl px-6 pb-32 pt-[calc(env(safe-area-inset-top,0px)+var(--tg-page-pt,2rem))] md:pt-[calc(env(safe-area-inset-top,0px)+var(--tg-page-pt-md,3rem))]">
        <div className="mb-10 flex flex-col items-start gap-3">
          ...
          <p className="text-base leading-7 text-muted-foreground">
            Карта живых покер-клубов Петербурга
          </p>
        </div>
